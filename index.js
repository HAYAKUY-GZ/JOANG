...
require('./message/npc')
nocache('./message/npc', module => console.log(`'${module}' Updated!`))
...
async function runbot() {
	...
	const banner = cfonts.render(('WHM MD'), {
		font: 'block',
		color: 'white',
		align: 'center',
		gradient: ["red", "yellow"],
	...
	//		if (mek.key.id.startsWith('BAE5') && mek.key.id.length === 16) return
			...
			require('./message/npc')(fdz, m, mek, chatUpdate, store)
		} catch (err) {
